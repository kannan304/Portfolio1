...
class Nav extends Component {
  ...
  render() {
    return (
      ...
      <nav id={style.Nav}>
        <a href="" id={style.name}> <img src={require("./Media/loo-transformed.webp")} alt="" /> Kannan J  </a>
        <div>
          <div class="overlay"></div>
          <ul ref={this.navbarRef} id={style.navbar}>

            <li><Link to="/" onClick={this.closeMenu}>Home</Link></li>
            <li><Link to="/about"  className={style.active} onClick={this.closeMenu}>Education</Link></li>
