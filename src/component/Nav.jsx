...
class Nav extends Component {
  ...
  render() {
    return (
      <nav id={style.Nav}>
        <a href="" id={style.name}>Kannan. J</a>
        <div>
          <ul ref={this.navbarRef} id={style.navbar}>

            <li><Link to="/" onClick={this.closeMenu}>Home</Link></li>
            <li><Link className={style.active} to=""onClick={this.closeMenu}>About Me</Link></li>
            <li><Link to="" onClick={this.closeMenu}>Skills</Link></li>
            <li><Link to="" onClick={this.closeMenu}>Project</Link></li>
            <li><Link to="" onClick={this.closeMenu}>Contact Me</Link></li>
          </ul>
        </div>
